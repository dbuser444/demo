...
public class JwtUntil {
    ...
    // Секретный ключ
    @Value("${jwt.secret:aVerySecretAndLongKeyForTokenSigningWhichShouldBeAtLeast256BitsLong}")
    ...
    //Создает токен, устанавливая имя пользователя (subject) и срок жизни.
    ...
    //Валидирует токен: проверяет имя пользователя и срок действия.
